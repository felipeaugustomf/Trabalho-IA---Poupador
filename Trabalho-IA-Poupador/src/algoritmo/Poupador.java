...
public class Poupador extends ProgramaPoupador {
	 ...
	 * percep��es al�m da movimenta��o realizada e sua utilidade
	 */
	...
	/**
	 * A fun��o sucessora calcula os estados sucessores de um dado estado.
	 * 
	 * @param estadoAtual
	...
	/**
	 * Calcula um novo estado do mundo baseado em uma movimenta��o realizada
	 * 
	 * @param movimentacao
	 *            movimenta��o a ser realizada
	 * @return Estado com a nova posi��o e percep��es.
	 */
	private Estado calculaNovoEstado(int movimentacao) {

		// BUG-FIX
		// IN�CIO C�PIA DAS MATRIZES
	...
	private int calculaUtilidade(Estado estado) {
		...
		// busca por posicao j� explorada, desfavorecendo sua exploracao
